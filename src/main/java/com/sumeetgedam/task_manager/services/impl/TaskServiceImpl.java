package com.sumeetgedam.task_manager.services.impl;
...
import com.sumeetgedam.task_manager.repositories.TaskListRepository;
import com.sumeetgedam.task_manager.repositories.TaskRepository;
...
public class TaskServiceImpl implements TaskService {
    ...
    public Task updateTask(UUID taskListId, UUID taskId, Task task) {
        ...
        if(null == task.getStatus()){
            throw new IllegalArgumentException("Task must haev a valid Status!!");
        }
